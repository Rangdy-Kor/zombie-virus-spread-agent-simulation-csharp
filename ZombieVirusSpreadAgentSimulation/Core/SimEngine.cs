...
public class SimEngine
{
    ...
    {
        public readonly float ZombieSpeed = e.ZombieSpeed,
            HumanSpeed = e.HumanSpeed,
            InfectionRadius = e.InfectionRadius;

        public readonly float StrongInfectionChance = e.StrongInfectionChance,
            WeakInfectionChance = e.WeakInfectionChance,
            DirectZombieChance = e.DirectZombieChance;

        public readonly float ZombieDetectRadius = e.ZombieDetectRadius,
            HumanDetectRadius = e.HumanDetectRadius,
            ZombieSeparationRadius = e.ZombieSeparationRadius;

        public readonly float CivilianToSurvivorChance = e.CivilianToSurvivorChance,
            InfectedToCarrierChance = e.InfectedToCarrierChance,
            CarrierToZombieChance = e.CarrierToZombieChance;

        public readonly float ZombieToRottenChance = e.ZombieToRottenChance,
            DeadToRottenChance = e.DeadToRottenChance,
            RottenToVanishedChance = e.RottenToVanishedChance;
